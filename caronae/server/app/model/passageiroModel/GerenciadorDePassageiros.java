...
public class GerenciadorDePassageiros {
    private HashMap<Integer, Passageiro> passageiros = new HashMap<>();
     ...
     */
    public Passageiro getPassageiro(Integer id) throws HttpException {
     ...
     */
    public void addPassageiro(Integer id) throws HttpException {
     ...
     */
    public boolean existePassageiro(Integer id) {
